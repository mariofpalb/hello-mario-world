...
export const themeConfig: ThemeConfig = {
  // SITE INFO ///////////////////////////////////////////////////////////////////////////////////////////
  site: {
    website: 'https://hello-mario-world.vercel.app/', // Site domain
    title: 'Hello Mario World!', // Site title
    author: 'Mario Fernández-Pacheco Albandea', // Author name
    description:
      'A little space of the internet where I would like to share my learnings in this adventurous world of software development', // Site description
    language: 'en-US' // Default language
  },

  // GENERAL SETTINGS ////////////////////////////////////////////////////////////////////////////////////
  general: {
    contentWidth: '70em', // Content area width
